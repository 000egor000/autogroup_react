...
const Destinations = (props) => {
    ...
    const [selectValueEditPlaceDestinations, setSelectValueEditPlaceDestinations] = useState([])
    ...
    const [selectValuePlaceDestinations, setSelectValuePlaceDestinations] = useState(1)
    ...
    const showIdLocation = (name,code, placeDestinations, id) => {
        ...
        setSelectValueEditPlaceDestinations(resIdPlaceDestinations ? resIdPlaceDestinations : '')
        setIdEdit(id ? id : '')
    ...
    let params = {
        ...
        place_destination_id: selectValuePlaceDestinations,
    }
                                    ...
                                    <Cell>
                                        {(rowData, rowIndex) => {
                                            return (
                                                ...
                                                >
                          {viewPorts(rowData.place_destinations)}
                        </span>
                                            )
                                        }}
                                    </Cell>
