...
const MastersfinancesEdit = (props) => {
  ...
  useEffect(() => {
    let count = []
    dispatch(showLoder({ finances: 1 }))
    getRequest(`/api/v1/finances/${id}`, {
      Authorization: `Bearer ${window.sessionStorage.getItem('access_token')}`,
    })
      .then((res) => {
                ...
                <div className="leftItemElement">
                  ...
                  <div className="settingGroup">
                    <button className="btn--black" type="submit">
                      Редактировать мастера финансов
                    </button>
...
export default MastersfinancesEdit
